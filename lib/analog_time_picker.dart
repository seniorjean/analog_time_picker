...
class AnalogTimePicker extends StatefulWidget {
  final ValueChanged<Map<String, DateTime?>>? onChanged;
...
class _AnalogTimePickerState extends State<AnalogTimePicker> {
            ...
            Card(
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 50.0, right: 50.0, bottom: 16.0),
  ...
  void _publishSelection(Map<String, DateTime?> _dateTime) {
...
class DateItem extends StatelessWidget {
  ...
  Widget _dateItem(DateModel _item) {
